    ...
    */
    public function getAdminItems()
    {
        return array(
            ...
            array(
                'label' => CrugeTranslator::t('admin', 'Gestionar Usuarios')
            ,
                'url' => $this->getUserManagementAdminUrl()
            ),
            array('label' => CrugeTranslator::t('admin', 'Campos Personalizados')),
            array(
                'label' => CrugeTranslator::t('admin', 'Lista de Perfil de Campos')
            ,
                'url' => $this->getFieldsAdminListUrl()
            ),
            array(
                'label' => CrugeTranslator::t('admin', 'Crear Perfil de Campos')
            ,
            ...
            array(
                'label' => CrugeTranslator::t('admin', 'Variable de Sistema')
            ,
