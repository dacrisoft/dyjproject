...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Consultora Contable D y J</title>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <a class="brand" href="<?php echo Yii::app()->baseUrl?>/site/index">Consultora Contable D Y J</a>
...
<section class="footer-credits">
    <div class="container">
        <ul class="clearfix">
            <li>© 2013 Consultora Contable D y J . All rights reserved.</li>
        </ul>
    </div>
